...
do
    ...
    git clone --branch ${XDIST_GIT_BRANCH} --depth 1 --no-tags -q git@github.com:edx/edx-platform.git;
    cd edx-platform; source /edx/app/edxapp/edxapp_env; pip install -qr requirements/edx/testing.txt' & "
